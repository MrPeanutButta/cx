...
namespace cx{
	...
	//        symbol_table_node_ptr array = p_function_id->defn.routine.locals.p_type_ids;
	//        if (!array) {
	 ...
	 * @return
	 */
	/*	cx_type * cx_parser::parse_complex_type(symbol_table_node_ptr p_function_id, symbol_table_node_ptr  p_node) {
			...
			symbol_table_node_ptr p_var_id = p_function_id->defn.routine.locals.p_type_ids;
