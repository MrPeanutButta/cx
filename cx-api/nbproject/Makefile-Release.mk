...
${OBJECTDIR}/_ext/1360937237/buffer.o: ../src/buffer.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/buffer.o ../src/buffer.cpp

${OBJECTDIR}/_ext/1360937237/common.o: ../src/common.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/common.o ../src/common.cpp

${OBJECTDIR}/_ext/1131172533/std_members.o: ../src/cx-debug/std_members.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1131172533
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1131172533/std_members.o ../src/cx-debug/std_members.cpp

${OBJECTDIR}/_ext/1360937237/error.o: ../src/error.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/error.o ../src/error.cpp

${OBJECTDIR}/_ext/1360937237/symtable.o: ../src/symtable.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/symtable.o ../src/symtable.cpp

${OBJECTDIR}/_ext/1360937237/types.o: ../src/types.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/types.o ../src/types.cpp
