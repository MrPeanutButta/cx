...
${OBJECTDIR}/examples/each.o: nbproject/Makefile-${CND_CONF}.mk examples/each.cx 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Iinclude -Iinclude/cx-debug -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/examples/each.o examples/each.cx

${OBJECTDIR}/examples/int.to_str.o: nbproject/Makefile-${CND_CONF}.mk examples/int.to_str.cx 
	${MKDIR} -p ${OBJECTDIR}/examples
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Iinclude -Iinclude/cx-debug -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/examples/int.to_str.o examples/int.to_str.cx

${OBJECTDIR}/examples/to_str.o: nbproject/Makefile-${CND_CONF}.mk examples/to_str.cx 
	${MKDIR} -p ${OBJECTDIR}/examples
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Iinclude -Iinclude/cx-debug -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/examples/to_str.o examples/to_str.cx

${OBJECTDIR}/examples/type_size.o: nbproject/Makefile-${CND_CONF}.mk examples/type_size.cx 
	${MKDIR} -p ${OBJECTDIR}/examples
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Iinclude -Iinclude/cx-debug -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/examples/type_size.o examples/type_size.cx
