...
${OBJECTDIR}/examples/int.to_str.o: examples/int.to_str.cx 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/examples/int.to_str.o examples/int.to_str.cx

${OBJECTDIR}/examples/to_str.o: examples/to_str.cx 
	${MKDIR} -p ${OBJECTDIR}/examples
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/examples/to_str.o examples/to_str.cx

${OBJECTDIR}/examples/type_size.o: examples/type_size.cx 
	${MKDIR} -p ${OBJECTDIR}/examples
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/examples/type_size.o examples/type_size.cx
...
${OBJECTDIR}/src/cx-debug/additive.o: src/cx-debug/additive.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/additive.o src/cx-debug/additive.cpp
...
${OBJECTDIR}/src/cx-debug/factor.o: src/cx-debug/factor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/factor.o src/cx-debug/factor.cpp
...
${OBJECTDIR}/src/cx-debug/init_list.o: src/cx-debug/init_list.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
...
${OBJECTDIR}/src/cx-debug/logical.o: src/cx-debug/logical.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/logical.o src/cx-debug/logical.cpp

${OBJECTDIR}/src/cx-debug/malloc.o: src/cx-debug/malloc.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/malloc.o src/cx-debug/malloc.cpp

${OBJECTDIR}/src/cx-debug/multiplicative.o: src/cx-debug/multiplicative.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/multiplicative.o src/cx-debug/multiplicative.cpp

${OBJECTDIR}/src/cx-debug/relational.o: src/cx-debug/relational.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/relational.o src/cx-debug/relational.cpp
...
${OBJECTDIR}/src/cx-debug/std_members.o: src/cx-debug/std_members.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/std_members.o src/cx-debug/std_members.cpp
...
${OBJECTDIR}/src/cx-debug/unary.o: src/cx-debug/unary.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/unary.o src/cx-debug/unary.cpp
...
${OBJECTDIR}/src/error.o: src/error.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/error.o src/error.cpp

${OBJECTDIR}/src/icode.o: src/icode.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/icode.o src/icode.cpp
...
${OBJECTDIR}/src/parse_type2.o: src/parse_type2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/parse_type2.o src/parse_type2.cpp
...
${OBJECTDIR}/src/symtable.o: src/symtable.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/symtable.o src/symtable.cpp

${OBJECTDIR}/src/tknnum.o: src/tknnum.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tknnum.o src/tknnum.cpp

${OBJECTDIR}/src/tknstrsp.o: src/tknstrsp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tknstrsp.o src/tknstrsp.cpp
