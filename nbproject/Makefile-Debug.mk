...
${OBJECTDIR}/src/cx-debug/additive.o: nbproject/Makefile-${CND_CONF}.mk src/cx-debug/additive.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/additive.o src/cx-debug/additive.cpp
...
${OBJECTDIR}/src/cx-debug/factor.o: nbproject/Makefile-${CND_CONF}.mk src/cx-debug/factor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/factor.o src/cx-debug/factor.cpp
...
${OBJECTDIR}/src/cx-debug/init_list.o: nbproject/Makefile-${CND_CONF}.mk src/cx-debug/init_list.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/init_list.o src/cx-debug/init_list.cpp
...
${OBJECTDIR}/src/cx-debug/multiplicative.o: nbproject/Makefile-${CND_CONF}.mk src/cx-debug/multiplicative.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/multiplicative.o src/cx-debug/multiplicative.cpp

${OBJECTDIR}/src/cx-debug/relational.o: nbproject/Makefile-${CND_CONF}.mk src/cx-debug/relational.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/relational.o src/cx-debug/relational.cpp
...
${OBJECTDIR}/src/cx-debug/unary.o: nbproject/Makefile-${CND_CONF}.mk src/cx-debug/unary.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cx-debug
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cx-debug/unary.o src/cx-debug/unary.cpp
